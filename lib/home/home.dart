...
//   void initState() {
//     super.initState();
//     _kunjunganStream = FirebaseFirestore.instance.collection('kunjungan').snapshots();
//   }
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color:
                                          const Color.fromARGB(255, 202, 196, 195),
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(10.0),
                                      ),
                                    ),
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          data['kunjungan'] ?? 'Kunjungan tidak ditemukan',
                                          style: TextStyle(fontSize: 20),
                                        ),
                                      ],
                                    ),
